...
/*
ユーザーがフォームなどで入力したものをhtmlに出力する場合は、e関数を使ってください。
XSS対策。
ユーザーが入力した文字列に<script>などが含まれていると、htmlの命令文とみなされて実行されてしまう。
e関数を用いることで、命令文ではなく文字列として扱われるようになる。詳しくはdatabase.phpを見てください。
*/
$data='ユーザーが入力した値';
echo e($data);
